...
export const ru = {
  ...
  pages: {
    ...
    continue: {
      ...
      titleIphone: "Добро пожаловать в личный кабинет сортировочного центра",
      paragraph1:
        "Вы получили доступ к официальному приложению сортировочного центра Почты Израиля.",
      paragraph1Iphone:
        "Вы получили доступ к официальному личному кабинету сортировочного центра Почты Израиля.",
      paragraph2:
