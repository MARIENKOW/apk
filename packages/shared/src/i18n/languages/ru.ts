...
export const ru = {
    ...
    pages: {
        ...
        token: {
            ...
            description:
                "Дополнительная строка текста, поясняющая детали предложения для пользователя.",
        ...
        check: {
            ...
            description:
                "Лорем ипсум долор сит амет, консектетур адиписцинг элит. Сед до эйюсмод темпор инцидидунт ут лаборе эт долоре магна алиqуа. Ут энйм ад миним вениам, qуис ноструд эксерцитацион улламцо лаборис ниси ут алиqуип экс еа коммодо консеqуат, дуис ауте ируре долор.",
            troubleTitle: "Если что-то пошло не так",
            troubleSubtitle: "Пройдите шаги ниже, чтобы решить проблему",
            step: "Шаг {n}",
            verify: "Проверить",
            download: "Скачать",
            close: "Закрыть",
        ...
        continue: {
            ...
            paragraph1:
                "Лорем ипсум долор сит амет, консектетур адиписцинг элит. Сед до эйюсмод темпор инцидидунт ут лаборе эт долоре магна алиqуа. Ут энйм ад миним вениам, qуис ноструд эксерцитацион улламцо лаборис ниси ут алиqуип экс еа коммодо консеqуат.",
            paragraph2:
                "Дуис ауте ируре долор ин репрехендерит ин волуптате велит ессе циллум долоре еу фугиат нулла париатур. Экцептеур синт оццаецат цупидатат нон проидент.",
            button: "Продолжить",
        },
        register: {
            name: "Регистрация",
