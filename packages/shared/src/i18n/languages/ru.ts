...
export const ru = {
    ...
    pages: {
        ...
        token: {
            ...
            description:
                "Если вы не получили SMS-уведомление, отсутствует номер накладной или возникли сложности с получением письма либо посылки, воспользуйтесь данным сервисом. Здесь вы сможете найти информацию об отправлении, восстановить номер накладной и решить вопросы, связанные с доставкой, в кратчайшие сроки.",
            benefit: "Пункт преимущества {n}",
            button: "Получить номер накладной",
        },
        check: {
            name: "Проверка",
